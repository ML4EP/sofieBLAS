...
#  include <cblas.h>
#else
#  error "No CPU BLAS backend selected. Define SOFIEBLAS_USE_MKL or SOFIEBLAS_USE_OPENBLAS."
#endif
...
template<>
class sofieBLAS<alpaka::TagCpuSerial>
{
public:
    using Impl = BlasCpu;
};
...
template<>
class sofieBLAS<alpaka::TagCpuOmp2Blocks>
{
public:
    using Impl = BlasCpu;
};
...
template<>
class sofieBLAS<alpaka::TagCpuOmp2Threads>
{
public:
    using Impl = BlasCpu;
};
...
template<>
class sofieBLAS<alpaka::TagCpuTbbBlocks>
{
public:
    using Impl = BlasCpu;
};
...
template<>
class sofieBLAS<alpaka::TagCpuThreads>
{
public:
    using Impl = BlasCpu;
};
